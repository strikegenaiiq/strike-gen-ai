  ...
  return (
    ...
    >
      <div className="space-y-4">
        <GoogleAuthButton label="Create with Google" />
        ...
        <form onSubmit={onSubmit} className="space-y-4" noValidate>
          <div>
            ...
            <input id="name" type="text" autoComplete="name" className="input" placeholder="Jane Creator" value={name.value} onChange={(e) => name.onChange(e.target.value)} onBlur={name.setTouched} aria-invalid={!!name.error} />
          ...
          <div>
            ...
            <input id="password" type="password" autoComplete="new-password" className="input" placeholder="At least 8 characters" value={password.value} onChange={(e) => password.onChange(e.target.value)} onBlur={password.setTouched} aria-invalid={!!password.error} />
          ...
          <button type="submit" className="btn-primary w-full" disabled={submitting}>{submitting ? "Creating account…" : "Create account"}</button>
        </form>
      </div>
    </AuthLayout>
  );
